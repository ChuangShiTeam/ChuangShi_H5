...
class MemberDeliveryOrderWarehouseReplaceDeliver extends Component {
    constructor(props) {
        super(props);
    ...
    handleAdd() {
        this.props.form.validateFields((errors, values) => {
            if (!errors) {
                ...
                values.member_delivery_order_is_warehouse_deliver = true; //仓库代发
                Toast.loading('加载中..', 0);
...
MemberDeliveryOrderWarehouseReplaceDeliver = createForm()(MemberDeliveryOrderWarehouseReplaceDeliver);

export default connect(() => ({}))(MemberDeliveryOrderWarehouseReplaceDeliver);
