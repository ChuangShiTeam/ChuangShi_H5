...
class MemberPurchaseOrderDetail extends Component {
    constructor(props) {
        super(props);
    ...
    handleLoad() {
        http.request({
            url: '/member/purchase/order/find',
            data: {
...
MemberPurchaseOrderDetail = createForm()(MemberPurchaseOrderDetail);

export default connect(() => ({}))(MemberPurchaseOrderDetail);
