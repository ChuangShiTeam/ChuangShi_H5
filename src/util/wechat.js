...
function auth() {
    ...
    if (open_id === '') {
        ...
        if (token === '') {
            window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + constant.wechat_app_id + '&redirect_uri=http%3A%2F%2Fapi.chuangshi.nowui.com%2Fwechat%2Fauth%3Furl%3D' + constant.index + '%26platform%3D' + constant.platform + '%26version%3D' + constant.version + '%26app_id%3D' + constant.app_id + '&response_type=code&scope=snsapi_base&state=123#wechat_redirect';
